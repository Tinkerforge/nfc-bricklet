...
// Configuration changed according to a fix in linux_libnfc-nci:
uint8_t NxpNci_RF_CONF_2ndGen_Blk1[]={0x20, 0x02, 0xA3, 0x13,
...
uint8_t NxpNci_RF_CONF_2ndGen_Blk2[]={0x20, 0x02, 0x15, 0x01,
